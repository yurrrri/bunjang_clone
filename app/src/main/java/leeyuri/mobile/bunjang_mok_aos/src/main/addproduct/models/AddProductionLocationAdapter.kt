...
class AddProductionLocationAdapter(val context: Context, private val locationList: ArrayList<Location>, val itemClick: (Location) -> Unit):
    RecyclerView.Adapter<AddProductionLocationAdapter.ItemViewHolder>(){
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): AddProductionLocationAdapter.ItemViewHolder {
    ...
    override fun onBindViewHolder(holder: AddProductionLocationAdapter.ItemViewHolder, position: Int) {
