...
import leeyuri.mobile.bunjang_mok_aos.src.login.LoginInsertCertiNumActivity

class LoginAgreeBottomSheet: BottomSheetDialogFragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.login_botomsheetdialog_agree, container, false)
    }
